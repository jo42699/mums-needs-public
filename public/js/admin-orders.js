...
// Delete order (from backend)
  async function deleteOrder() {
    if(!currentOrderId || !confirm("are you sure you want to delete this order?")) return;
    try {
...
// Render pagination buttons based on number of rows
  function renderPaginationButtons(rows){
  ...
  function updatePagination(){ currentPage=1; applyPagination(); }
